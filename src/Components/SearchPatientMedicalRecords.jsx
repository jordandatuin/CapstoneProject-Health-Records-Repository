...
function SearchPatientMedicalRecords() 
{
    ...
    const {setSearchPatientMedicalRecord} = useContext(Context)
                ...
                <div value={searchFilterRecords}>
                    <input  
                        ...
                        onChange={e => 
                        {
                            ...
                            setSearchPatientMedicalRecord(e.target.value.toLowerCase())
                        }}
                    />
                </div>
            </div>
...
export default SearchPatientMedicalRecords